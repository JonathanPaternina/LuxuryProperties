...
namespace LuxuryProperties.Data.Migrations
{
    ...
    [Migration("20240928071610_MigracionFix4")]
    partial class MigracionFix4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LuxuryProperties.Shared.PropertyImage", b =>
                {
                    ...
                    b.Property<int>("IdProperty1")
                        .HasColumnType("int");

                    b.HasKey("IdPropertyImage");

                    b.HasIndex("IdProperty1");
            ...
            modelBuilder.Entity("LuxuryProperties.Shared.PropertyImage", b =>
                {
                    b.HasOne("LuxuryProperties.Shared.Property", "IdProperty")
                        .WithMany()
                        .HasForeignKey("IdProperty1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("IdProperty");
                });
