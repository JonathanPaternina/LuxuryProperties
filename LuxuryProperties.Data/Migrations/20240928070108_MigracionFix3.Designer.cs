...
namespace LuxuryProperties.Data.Migrations
{
    ...
    [Migration("20240928070108_MigracionFix3")]
    partial class MigracionFix3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LuxuryProperties.Shared.Property", b =>
                {
                    ...
                    b.Property<int>("PropertyImageIdPropertyImage")
                        .HasColumnType("int");

                    b.Property<int>("PropertyTraceIdPropertyTrace")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PropertyImageIdPropertyImage");

                    b.HasIndex("PropertyTraceIdPropertyTrace");
            ...
            modelBuilder.Entity("LuxuryProperties.Shared.Property", b =>
                {
                    ...
                    b.HasOne("LuxuryProperties.Shared.PropertyImage", "PropertyImage")
                        .WithMany()
                        .HasForeignKey("PropertyImageIdPropertyImage")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LuxuryProperties.Shared.PropertyTrace", "PropertyTrace")
                        .WithMany()
